    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
            <a href="{{ route('ads_banner.create') }}" class="btn btn-sm btn-primary  float-right"><i class="fas fa-plus"></i> Add @yield('page')</a>
...
<script>
    $(document).on('change','.status_toggle', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('ads_banner.status_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
                if (data.message){
                        toastr.options =
