                    ...
                    <div class="dashboard_content mt-50" id="myads">
                        ...
                        <div class="warpper pt-20">
                            <div class="col-sm-2" id="cv_list" style="display: flex;align-items: center;gap: 1.5rem;border: 1px solid rgba(0,0,0,.1);">
                                @forelse ($cv_bank as $c)
                                <a href="{{ route('customer_job.cv_download','') }}/{{ $c->id }}" target="_blank" style="text-align: center;margin-top:10px;margin-left:-3px;margin-bottom: 1rem">
