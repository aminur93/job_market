    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-50">
                ...
                <form action="" method="post" id="customer_banner_ads_post">
                    @csrf
                    <div class="row">
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#customer_banner_ads_post").on("submit",function (e) {
                e.preventDefault();

                var formData = new FormData( $("#customer_banner_ads_post").get(0));

                $.ajax({
                    url : "{{ route('customer_ads_banner.store') }}",
                    type: "post",
                    data: formData,
                    dataType: "json",
                    contentType: false,
