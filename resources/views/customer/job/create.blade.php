    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-50">
                ...
                <h5>Customer Job Create</h5><hr>
               
                <form action="" method="post" id="customer_job_post">
                    @csrf
                    <div class="row">
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#customer_job_post").on("submit",function (e) {
                e.preventDefault();

                var formData = new FormData( $("#customer_job_post").get(0));

                $.ajax({
                    url : "{{ route('customer_job.store') }}",
                    type: "post",
                    data: formData,
                    dataType: "json",
                    contentType: false,
