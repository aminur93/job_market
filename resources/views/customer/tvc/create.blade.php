    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-50">
                ...
                <form action="" method="post" id="customer_tvc_post">
                    @csrf
                    <div class="row">
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#customer_tvc_post").on("submit",function (e) {
                e.preventDefault();

                var formData = new FormData( $("#customer_tvc_post").get(0));

                $.ajax({
                    url : "{{ route('customer_tvc.store') }}",
                    type: "post",
                    data: formData,
                    dataType: "json",
                    contentType: false,
