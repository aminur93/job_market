            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="dashboard_content mt-50" id="myads">
                        <div class="post_title">
                            <h5 class="title">My Tvc</h5>
                        </div>

                        <div class="text-right mt-3">
                            <a href="{{ route('customer_tvc.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>  Tvc Create</a>
                        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            ajax: {
                url: '{!!  route('customer_tvc.getData') !!}',
                type: "GET",
                headers: {
