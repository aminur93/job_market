...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout()
    {
        ...
        $customer_info = Customer::select('customers.*','ads.unit_price as unit_price','ads.title as title','ads.id as ads_id')
        ...
        return view('exampleEasycheckout', compact('all_category','ads_count','customer','customer_info'));
    }
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = (int) $request->total_amount; # You cant not pay less than 10
        ...
        $post_data['ship_add2'] = $request->customer_address;
        $post_data['ship_city'] = $request->state;
